...
<html>
    ...
    <body>
        <div class="main">
            ...
            <div class="rowtop">
                <h1>Realme 5 Pro (8GB/128GB)</h1>
                
            </div>
            <div class="rowInfo">
                <div class="imageInfo">
                    <img src="../image/realme/realme-5-pro-8gb-green-600x600.jpg">
                </div>
                <div class="info">
                ...
                <div class="detailInfo">
                        <div class="info">
                                ...
                                <li>
                                        ...
                                        <div>
                                            Quay phim HD 720p@30fps,Quay phim siêu chậm 960 fps,Quay phim FullHD 1080p@30fps,Quay phim FullHD 1080p@60fps,Quay phim 4K 2160p@30fps
                                        </div>
                                    </li>
                                <li> 
                                        <span>Đèn Flash</span>
                                ...
                                <li> 
                                        ...
                                        <div>
                                            Siêu cận (Macro),Góc siêu rộng (Ultrawide),Xoá phông,Quay chậm (Slow Motion)...
                                        </div>
                                </li>
                                ...
                                <li> 
                                        ...
                                        <div>
                                            Xoá phông, Flash màn hình, Quay video HD, Nhận diện khuôn mặt,Làm đẹp (Beautify),Quay video Full HD,Tự động lấy nét (AF),HDR
                                        </div>
                                </li>
                                ...
                                <li> 
                                        ...
                                        <div>
                                            Tiết kiệm pin, Siêu tiết kiệm pin, Sạc nhanh VOOC
                                        </div>
                                </li>
