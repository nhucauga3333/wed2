...
<html>
    ...
    <body>
        <div class="main">
            ...
            <div class="rowtop">
                <h1>Huawei Nova 3i Trắng</h1>
                
            </div>
            <div class="rowInfo">
                <div class="imageInfo">
                    <img src="../image/huawei/huawei-nova-3i-trang-11-600x600.jpg">
                </div>
                <div class="info">
                    ...
                    <li> 
                        <span>Màn hình </span>
                        <div>
                            6.3 inchs, Full HD +, 1080 x 2340 Pixels
                        </div>
                    </li>
                    <li> 
                    ...
                    <li> 
                            ...
                            <span>CPU</span>
                            <div>
                                HUAWEI Kirin 710, 8, 4xCortex A73 2.2GHz + 4xCortex A53 1.7GHz
                            </div>
                    </li>
                    <li> 
                            <span>RAM</span>
